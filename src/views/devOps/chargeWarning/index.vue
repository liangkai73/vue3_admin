    ...
    <pageView>
        <template #head>
            <el-breadcrumb separator="/">
                <el-breadcrumb-item :to="{ path: 'cooperation/manageList' }">充电桩预警</el-breadcrumb-item>
            </el-breadcrumb>
        </template>
        ...
        <card class="table-container mt20" :gutter="16">
            ...
            <div class="mt20">
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column prop="wxname" label="报警编号" />
                    <el-table-column prop="date" label="时间" />
                    <el-table-column prop="deposit" label="报警内容" />
                    <el-table-column prop="package" label="电桩编号" />
                    <el-table-column prop="temStr" label="所属电站" />
                    <el-table-column prop="dattemStre" label="所属代理商" />
                    <el-table-column prop="temStr" label="状态" />
                    <el-table-column label="操作" width="350">
                        <template #default="scope">
                            <el-button size="small" @click="handleOrder('detail', scope.row)">位置</el-button>
                            <el-button size="small" @click="handleOrder('charge', scope.row)">短信发送</el-button>
                            <el-button size="small" @click="handleOrder('charge', scope.row)">处理记录</el-button>
                        </template>
                    </el-table-column>
                </el-table>
